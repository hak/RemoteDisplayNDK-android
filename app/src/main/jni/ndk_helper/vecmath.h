...
public:
    ...
    static Mat4 Perspective( float fLeft, float fRight, float fBottom, float fTop, float fNear, float fFar );
    ...
    static Mat4 Rotation( float fAngle, float fX, float fY, float fZ );
